...
function SplashCursor({
  targetRef, // Add targetRef to props
  SIM_RESOLUTION = 128,
  DYE_RESOLUTION = 1440,
  ...
  useEffect(() => {
    ...
    // --- Start of existing WebGL/Canvas logic ---
    ...
    // --- End of existing WebGL/Canvas logic ---
    ...
    window.addEventListener('mouseup', onMouseUp); // Mouse up can happen anywhere
    ...
    targetRef, // Add targetRef to dependency array
    SIM_RESOLUTION,
    DYE_RESOLUTION,
    CAPTURE_RESOLUTION,
    DENSITY_DISSIPATION,
