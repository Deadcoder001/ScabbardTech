            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className="flex justify-center items-center mb-6">
                  <div className="relative z-10 flex items-center justify-center w-24 h-24 bg-gray-50 rounded-full">
                    <div className="flex items-center justify-center w-20 h-20 bg-white rounded-full shadow-md text-purple-600 overflow-hidden">
                      {step.icon}
                    </div>
                  </div>
                </div>
