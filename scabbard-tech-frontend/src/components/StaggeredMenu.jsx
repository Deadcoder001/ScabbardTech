...
export const StaggeredMenu = ({
  position = 'right',
  colors = ['#3a0ca3', '#21075e'],
  items = [],
  socialItems = [],
  displaySocials = true,
  displayItemNumbering = true,
  className,
  logoUrl = '/scabbardtech.png',
  menuButtonColor = '#fff',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[1.2em] md:p-[2em] bg-transparent pointer-events-none z-20"
