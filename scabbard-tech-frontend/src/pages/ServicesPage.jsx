...
import heroBg from '../assets/gallery/Scabbardtech-Portfolio-24.png'; // <-- Use your actual image path
...
const servicesData = [
  ...
  { title: 'Content Creation', description: 'From compelling blog posts to engaging videos and regional language content, we create materials that resonate with your audience.', icon: <IconContent /> },
  {
    ...
    description: 'At Scabbard Tech, we specialize in brand development that helps your business stand out in a crowded market.',
    icon: <IconBrandDev />
  },
  { title: 'Brand Identity & Strategy', description: 'Develop a memorable brand with our comprehensive branding services, including logo design, messaging, and market positioning.', icon: <IconBranding /> },
];
